...
Also, the development version of DIETCOST is available in [GitHub](https://github.com/):
...
```{r DIETCOST::monteCarloSimulation, eval=FALSE}
library(DIETCOST)
...
Please report any bugs or submit any queries either to this GitHub repo or to h@bracarense.com.